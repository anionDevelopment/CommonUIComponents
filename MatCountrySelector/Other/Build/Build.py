...
def build():
    ...
    tf.build("mat_country_selector",[],add_readme_of_codeunit_to_package=True,add_license_of_repository_to_package=True,add_changelog_of_repository_to_package=True)
